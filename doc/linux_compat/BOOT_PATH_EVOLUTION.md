...
> **Not**: 实时妥协清单（见 [`BUSYBOX_BOOT_DEFERRALS.md`](BUSYBOX_BOOT_DEFERRALS.md)）、rootfs 操作说明（见 [`ROOTFS.md`](ROOTFS.md)）、initramfs 原设计（见 [`INITRAMFS_PLAN.md`](INITRAMFS_PLAN.md)）。  
...
**里程碑**：2026-07-13 `ls /bin` exit 0；细节与开放妥协 → `BUSYBOX_BOOT_DEFERRALS.md`。
...
开放项仍以 [`BUSYBOX_BOOT_DEFERRALS.md`](BUSYBOX_BOOT_DEFERRALS.md) 文首表为准。
...
| [`BUSYBOX_BOOT_DEFERRALS.md`](BUSYBOX_BOOT_DEFERRALS.md) | **仍欠的妥协**与回收优先级（live） |
