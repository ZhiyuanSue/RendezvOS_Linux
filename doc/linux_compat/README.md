...
| [`BUSYBOX_BOOT_DEFERRALS.md`](BUSYBOX_BOOT_DEFERRALS.md) | busybox demo 临时妥协（Path B 等；容量项已迁动态表） |
| [`VFS_DYNAMIC_STORAGE.md`](VFS_DYNAMIC_STORAGE.md) | **VFS page_slice 可增长表（替代定长 BSS/栈）** |
