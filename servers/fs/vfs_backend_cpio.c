...
{
        static ipc_rpc_coop_queue_t vfs_cpio_coop_q;
        i64 reg_ret;

        reg_ret = vfs_backend_ipc_leaf_run(VFS_BACKEND_PORT_CPIO,
...
{
        (void)vfs_backend_ipc_leaf_spawn(VFS_BACKEND_PORT_CPIO,
                                         "vfs_cpio_backend_thread",
                                         "cpio",
                                         &vfs_cpio_service_id,
                                         &vfs_cpio_thread_ptr,
                                         vfs_cpio_thread_entry,
                                         &vfs_cpio_server_done);
}
